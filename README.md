...
[What is the x64 Architecture](https://docs.microsoft.com/en-us/windows-hardware/drivers/debugger/x64-architecture?redirectedfrom=MSDN)

[Assembly Language Book](https://www.syncfusion.com/ebooks/assemblylanguage)
...
[Understanding the differences between 8bit, 16bit, 32bit, and 64bit](https://www.youtube.com/watch?v=_SkpnG571z8&ab_channel=ArrowElectronics)

[LordNoteworthy CPU Internals](https://github.com/LordNoteworthy/cpu-internals)

[FLAGS register](https://en.wikipedia.org/wiki/FLAGS_register)

[Stack Frames and how they work](https://www.cs.rutgers.edu/~pxk/419/notes/frames.html)
...
[Visual Studio Code Assembly](https://github.com/newtonsart/vscode-assembly)
...
[Nightmare Book](https://guyinatuxedo.github.io/)

[BinExp Course](https://github.com/r0hi7/BinExp)
...
[Buffer overflow Windows exploit development practice - 50 proof of concepts](https://github.com/FULLSHADE/OSCE)
...
[Bypassing Mitigations by Attacking JIT Server in Microsoft Edge](https://googleprojectzero.blogspot.com/2018/05/bypassing-mitigations-by-attacking-jit.html?m=1)

[Understanding type confusion vulnerabilities](https://www.microsoft.com/security/blog/2015/06/17/understanding-type-confusion-vulnerabilities-cve-2015-0336/)

[Kernel-mode Payloads on Windows](http://www.uninformed.org/?v=3&a=4&t=pdf)

[Windows SMEP bypass](https://www.coresecurity.com/core-labs/publications/windows-smep-bypass-us)

[Kernel Hacking With HEVD](https://sizzop.github.io/2016/07/07/kernel-hacking-with-hevd-part-3.html)
...
[Return-into-libc without Function Calls](https://hovav.net/ucsd/dist/geometry.pdf)
...
[Heap Overflows for Humans](http://repository.root-me.org/Exploitation%20-%20Syst%C3%A8me/Microsoft/EN%20-%20Heap%20Bug%20-%20Heap%20Overflows%20For%20Humans.pdf)
...
[IDAPython](https://magiclantern.fandom.com/wiki/IDAPython)
...
[Cutter RE Platform Powered by Radare2](https://cutter.re/)
...
[Reverse Engineering Videos](https://www.youtube.com/user/OpenSecurityTraining/playlists)

[Malware Analysis For Hedgehogs](https://struppigel.blogspot.com/2017/06/training-1-file-type-analysis-and-code.html?view=sidebar)
...
[Case Study of VMware Guest-To-Host escape vulnrabilities](https://www.blackhat.com/docs/eu-17/materials/eu-17-Mandal-The-Great-Escapes-Of-Vmware-A-Retrospective-Case-Study-Of-Vmware-G2H-Escape-Vulnerabilities.pdf)

[Escape from VMware Workstation by using "Hearthstone"](https://cansecwest.com/slides/2017/CSW2017_QinghaoTang_XinleiYing_vmware_escape.pdf)

[VMWare GuestRPC mechanism](http://sysprogs.com/legacy/articles/kdvmware/guestrpc.shtml)
...
[CTP/OSCE Course Preparation - HeapSpray + SEH + EggHunter](https://blog.pwn.al/security/ctp/osce/exploitation/2017/07/06/osce-ctp-prep-heapspreay-seh-egghunter.html)

[AWE/OSEE Preparation](https://github.com/timip/OSEE)
...
[Perfect Malware Samples](https://github.com/Perfectdotexe/Perfect-Malware-Samples)
...
[Getting familiar with HackSys Extreme Vulnerable Driver](https://www.youtube.com/watch?v=0wWT-YovwgM&ab_channel=hasherezade)

[Magic Number Database](https://www.magnumdb.com/)

[Online Crypto Course](https://crypto.stanford.edu/~dabo/courses/OnlineCrypto/)

[Awesome Pen Testing](https://github.com/enaqx/awesome-pentest)

[Sample Pen Test Resume](https://github.com/hmaverickadams/Sample-Pentest-Resume)
